...
Jira виртуализирует длинные колонки — карточки вне области видимости могут
отсутствовать в DOM, и тогда сумма учитывает только отрисованные карточки.
Прокрутите колонку, чтобы подгрузить остальные.
